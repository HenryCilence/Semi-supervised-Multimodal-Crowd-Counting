...
try:
    from models.CAGNet.VGG import VGG16, VGG19
    from models.CAGNet.Fusion import CAFM
    from models.CAGNet.Decoder import ADFM
except:
    from VGG import VGG16, VGG19
    from Fusion import CAFM
    from Decoder import ADFM
...
#         return torch.abs(self.reg_layer(f))
