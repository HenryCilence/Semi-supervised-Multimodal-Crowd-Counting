...
def parse_args():
    ...
    parser.add_argument('--model-name', default='bm', help='the name of the model')
    parser.add_argument('--train-dir', default=r"",
                        help='training data directory')
    parser.add_argument('--val-dir', default=r"",
                        help='validating data directory')
    parser.add_argument('--save-dir', default=r"./check/",
                        help='directory to save models.')
    parser.add_argument('--info', default='rgbtcc-5',
    ...
    parser.add_argument('--unlabel-start', type=int, default=10,
...
if __name__ == '__main__':
    ...
    # from utils.regression_trainer_mt import RegTrainer
    from utils.regression_trainer_multi import RegTrainer
